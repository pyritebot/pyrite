...
export default class AntiAlts {
	data = new SlashCommandBuilder()
		.setName('antialts')
		.setDescription('Toggle Anti alts in your server (this will block every alt account that joins your server)!')
		.setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
		.addSubcommand(subcommand => subcommand.setName('on').setDescription('turn anti alts on!'))
		.addSubcommand(subcommand => subcommand.setName('off').setDescription('turn anti alts off!'));
