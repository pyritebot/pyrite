	...
	data = new SlashCommandBuilder()
  	...
  	.addSubcommand(subcommand =>
        ...
        .addRoleOption(option =>
					option.setName('role').setDescription("The default member role that will be set").setRequired(true)	
				)
    )
    .addSubcommand(subcommand =>
			subcommand
        ...
        .addRoleOption(option =>
					option.setName('role').setDescription("The default moderator role that will be set").setRequired(true)
				)
		)
  	.addSubcommand(subcommand =>
			subcommand
        ...
        .addUserOption(option =>
					option.setName('user').setDescription("The user that will be made an admin").setRequired(true)
				)
		)
		.addSubcommand(subcommand => 
			subcommand
  	...
  	.addSubcommand(subcommand =>
			subcommand
				.setName('show')
				.setDescription('The all whitelisted roles')
    )
		.addSubcommand(subcommand => 
			subcommand
				.setName('remove')
				.setDescription('Set a whitelist option to defaults or remove an admin/owner')
				.addStringOption(option => option.setName('setting').setDescription('What setting you wanna change').addChoices(
						{
							name: 'member',
							value: 'member',
						},
	...
	async run(interaction: CommandInteraction) {
	    ...
	    switch (interaction.options.getSubcommand()) {
	        ...
	        break;
				...
				case 'admin':
					const member = interaction.options.getMember('user') as Message
	        ...
	        break;
				...
				case 'owner':
					const owner = interaction.options.getMember('user') as Message
