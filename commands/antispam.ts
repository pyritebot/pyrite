...
export default class AntiSpam {
  data = new SlashCommandBuilder()
    ...
    .addSubcommand(subcommand =>
			subcommand
				.setName('on')
				.setDescription('turn anti spam on!')
    )
    .addSubcommand(subcommand =>
			subcommand
				.setName('off')
				.setDescription('turn anti spam off!')
		)
		.addSubcommand(subcommand =>
			subcommand
				.setName('minutes')
		...
		.addSubcommand(subcommand =>
			subcommand
				...
				.addIntegerOption(option =>
					option.setName('limit').setDescription('You can pass an integer which will the determines the amount of messages before a mute').setRequired(true)
				)
		)
