...
export default class Logger {
  data = new SlashCommandBuilder().setName("logs").setDefaultMemberPermissions(PermissionFlagsBits.Administrator).setDescription("Manage the custom logger to see the actions that your mods and members do in the server").addSubcommand(
