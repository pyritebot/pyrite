...
export default class AntiRaid {
  data = new SlashCommandBuilder().setName("antiraid").setDescription("Turn on the anti raid feature").setDefaultMemberPermissions(PermissionFlagsBits.Administrator).addSubcommand(
    (subcommand) => subcommand.setName("on").setDescription("Turn on anti raid!")
  ).addSubcommand(
    (subcommand) => subcommand.setName("off").setDescription("Turn off anti raid!")
  );
