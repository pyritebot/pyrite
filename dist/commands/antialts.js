...
export default class AntiAlts {
  data = new SlashCommandBuilder().setName("antialts").setDescription(
    ...
    (subcommand) => subcommand.setName("on").setDescription("turn anti alts on!")
  ).addSubcommand(
    (subcommand) => subcommand.setName("off").setDescription("turn anti alts off!")
  );
