...
export default class AntiToxicity {
  data = new SlashCommandBuilder().setName("antitoxicity").setDescription(
    ...
    (subcommand) => subcommand.setName("on").setDescription("Turn toxicity filter on!")
  ).addSubcommand(
    (subcommand) => subcommand.setName("off").setDescription("Turn toxicity filter off!")
  );
