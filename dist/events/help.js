...
export default class Help {
  ...
  async run(interaction) {
    ...
    if (interaction.customId !== "help_select")
      return;
    const helpEmbed = new EmbedBuilder({ color: 2829617 });
...
`
      ...
      case "moderation":
        ...
        break;
      case "verification":
        helpEmbed.setTitle("<:check:1027354811164786739> Verification").setDescription("> Here's a list of the verification commands").setFields(
