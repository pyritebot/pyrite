...
export default class Help {
  constructor() {
    this.data = new SlashCommandBuilder().setName("help").setNameLocalizations({ "es-ES": "ayuda" }).setDescription("Display the help command!").setDescriptionLocalizations({ "es-ES": "Mostrar el comando de ayuda (en ingl\xE9s)" });
  }
  async run(interaction) {
    const helpEmbed = new EmbedBuilder({
      title: "<:pyrite:1014918476982394891> Pyrite Bot",
      description: "<:1412reply:1009087336828649533> Welcome to **Pyrite Bot** heres a list of my features below. If you need help using any scroll down in the select menu for them.",
      fields: [
