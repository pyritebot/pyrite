...
export default class Setup {
  constructor() {
    this.data = new SlashCommandBuilder().setName("setup").setDescription("Setup the Bot in this server!").setDefaultMemberPermissions(PermissionFlagsBits.Administrator);
  }
